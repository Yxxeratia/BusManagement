...
public class Login extends JPanel  {
	...
	public Login() {
		...
		lblUsername.setBounds(199, 174, 87, 38);
		add(lblUsername);
		
		lblPassword = new JLabel("Password:");
		lblPassword.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblPassword.setBounds(199, 243, 87, 32);
		add(lblPassword);
		
		usernameField = new JTextField();
		usernameField.setFont(new Font("Tahoma", Font.PLAIN, 12));
		usernameField.setBounds(327, 181, 96, 19);
		add(usernameField);
		usernameField.setColumns(10);
		
		passwordField = new JPasswordField();
		passwordField.setFont(new Font("Tahoma", Font.PLAIN, 12));
		passwordField.setBounds(327, 251, 96, 19);
		passwordField.setEchoChar('*');
		add(passwordField);
		
		btnLogin = new JButton("Login");
		btnLogin.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnLogin.setBounds(464, 378, 118, 38);
		add(btnLogin);		
		
		lblRole = new JLabel("Role:");
		lblRole.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblRole.setBounds(199, 301, 76, 32);
		add(lblRole);
		...
		comboBoxRole.setBounds(330, 308, 93, 21);
		add(comboBoxRole);
		
		JPanel headPane = new JPanel();
		headPane.setBounds(0, 0, 699, 124);
		add(headPane);
		...
		lblHead.setBounds(209, 10, 303, 90);
